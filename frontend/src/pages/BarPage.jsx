...
import { cn, formatTime, getTimeElapsed, getUrgencyLevel, getUrgencyColor, getStatusLabel } from '../lib/utils';
...
export default function BarPage() {
    ...
    const loadOrders = async () => {
        try {
            const response = await ordersAPI.getByDepartment('bar');
    ...
    return (
        <div className="min-h-screen bg-stone-100 p-4" data-testid="bar-page">
            {/* Header */}
            ...
            {orders.length === 0 ? (
                <div className="flex flex-col items-center justify-center h-[60vh] text-stone-500">
                    <Wine className="w-16 h-16 mb-4 opacity-20" />
                    ...
                    {orders.map((order) => {
                        ...
                        return (
                            <Card 
                                ...
                                data-testid={`bar-order-${order.order_number}`}
                            >
